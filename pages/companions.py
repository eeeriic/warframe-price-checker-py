...
st.title("Prime Companion Sets and Parts")

# Load CSVs
companion_sets_path = os.path.join(DATA_FOLDER, "companion_sets.csv")
df_sets = pd.read_csv(companion_sets_path)
...
st.header("Companion Prime Sets")
