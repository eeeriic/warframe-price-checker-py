...
st.title("Prime Weapon Sets and Parts")

# Load CSVs
weapon_sets_path = os.path.join(DATA_FOLDER, "weapon_sets.csv")
df_sets = pd.read_csv(weapon_sets_path)
